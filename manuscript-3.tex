...
Since (\emph{ii}) is well established in the literature (c.f. Prokhorov’s theorem or Theorem 5.2 in \cite{billingsley2013convergence}) and (\emph{iii}) follows from the Stone-Weierstrass theorem, we will focus on the proof of (\emph{i}).
